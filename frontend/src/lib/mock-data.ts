...
export const mockCrops: Crop[] = [
  {
    ...
    environmentalRequirements: {
      optimalTempMinC: 15, optimalTempMaxC: 22, heatStressThresholdC: 28,
  ...
  },
  {
    ...
    waterRequirement: "MEDIUM",
    environmentalRequirements: {
      optimalTempMinC: 15, optimalTempMaxC: 22, heatStressThresholdC: 30,
      optimalHumidityMinPct: 60, optimalHumidityMaxPct: 80,
      lightRequirementParMin: 250, lightRequirementParMax: 500,
      optimalCo2PpmMin: 800, optimalCo2PpmMax: 1200,
      optimalPhMin: 5.0, optimalPhMax: 6.0,
    },
    stressSensitivities: ["HEAT", "OVERWATERING"],
    nutritionalProfile: {
  ...
  },
  {
    ...
    growthDays: 100,
    harvestIndex: 0.45,
    typicalYieldPerM2Kg: 2.5,
    waterRequirement: "MEDIUM",
    environmentalRequirements: {
      optimalTempMinC: 20, optimalTempMaxC: 30, heatStressThresholdC: 35,
      optimalHumidityMinPct: 60, optimalHumidityMaxPct: 80,
      lightRequirementParMin: 300, lightRequirementParMax: 600,
      optimalCo2PpmMin: 800, optimalCo2PpmMax: 1200,
    ...
    nutritionalProfile: {
      caloriesPer100g: 446, proteinG: 36.5, carbsG: 30.2, fatG: 19.9, fiberG: 9.3,
  ...
  },
  {
    ...
    growthDays: 25,
    harvestIndex: 0.7,
    typicalYieldPerM2Kg: 2.0,
    waterRequirement: "LOW",
    environmentalRequirements: {
      optimalTempMinC: 10, optimalTempMaxC: 18, heatStressThresholdC: 25,
      optimalHumidityMinPct: 40, optimalHumidityMaxPct: 60,
      lightRequirementParMin: 200, lightRequirementParMax: 400,
      optimalCo2PpmMin: 800, optimalCo2PpmMax: 1200,
      optimalPhMin: 6.0, optimalPhMax: 7.0,
